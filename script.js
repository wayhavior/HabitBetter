                    ...
                    <div style="padding: 1rem 1.25rem; display: flex; justify-content: space-between; align-items: center;">
                        <div style="display: flex; align-items: center; gap: 0.75rem;">
                            ...
                            <div>
                                ...
                                <p style="font-size: 12px; color: rgba(255,255,255,0.6); margin: 0.25rem 0 0 0;">v1.0.7</p>
                            </div>
                        </div>
                        <div style="font-size: 16px; color: rgba(255,255,255,0.5); font-weight: 600;">v1.0.7</div>
                    </div>
                </div>
            </div>
        </div>
